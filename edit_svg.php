...
<div style="font-weight:400;">
  <div class="wrapper">
    ...
    <header class="main-header">
      <!-- Logo -->
      <a class="logo" style="background-color: #c64444;">
    ...
    <aside class="main-sidebar">
      <section class="sidebar" >
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li>
            <a href="index.php?user=<?php echo $_GET['user']?>">
          ...
          <!-- menu-open -->
          <li class="active treeview menu-open" id = "menu-name-for-site">
            <a href="#">
            ...
            <ul class="treeview-menu" style="display: block;" id = "menu-for-side">
              <li class= "active">
                <a href="edit_svg.php" style="font-size:16px;">
          ...
          <section class="col-lg-12">
            <div class="box box-primary">
              <div class="box-header">
                ...
                <h1 class="box-title" style=" font-size: 1.8em;padding-right:2%;">Edit-SVG</h1>
              </div>
              <div >
                <div class="container-fluid">
                  <div class="row">
                    <iframe src="http://34.69.243.34/iot/" frameborder="0" height = '600px' width = '100%'></iframe>
                  </div>
                </div>
              </div>
            </div>
...
$( document ).ready(function() {
    if (check_token('<?php echo $_GET['user'];?>')){
    ...
    try {
      ...
      for_side_bar("edit_svg.php?user=<?php echo $_GET['user'] ?>");
