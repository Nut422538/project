...
<head>
  ...
  <title>edit-Project-Node-red</title>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="active treeview menu-open" id = "menu-name-for-site">
            ...
            <ul class="treeview-menu" style="display: block;" id = "menu-for-side">
              ...
              <li class= "active">
                <a href="edit_node_red.php" style="font-size:16px;">
                <i class="fa fa-circle-o" style= "color: #b593f6;"></i>
                Node-Red
                </a>
              </li>
          ...
          <section class="col-lg-12">
            <div class="box box-primary">
              <div class="box-header">
                ...
                <h1 class="box-title" style=" font-size: 1.8em;padding-right:2%;">Edit-Node-Red</h1>
              </div>
              <div >
                <div class="container-fluid">
                  <div class="row">
                    <iframe src="http://34.69.243.34:1880" frameborder="0" height = '600px' width = '100%'></iframe>
                  </div>
                </div>
              </div>
            </div>
